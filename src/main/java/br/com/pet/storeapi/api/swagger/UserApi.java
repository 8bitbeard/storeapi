...
public interface UserApi {
    ...
    @Operation(summary = "Create a new Admin user for the application",
            description = "Create a new Admin user for the application. This operation can only be performed by an Logged in ADMIN user")
    UserResponseDTO createUser(@RequestBody @Valid UserRequestDTO userRequestDTO);

    @Operation(summary = "List all users of the application",
            description = "List all users of the application. This operation can only be performed by an Logged in ADMIN user")
