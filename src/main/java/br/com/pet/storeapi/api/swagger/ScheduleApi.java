...
public interface ScheduleApi {
  ...
  @Operation(
      summary = "Create a new appointment for a pet",
      description =
          "Create a new appointment for a pet from a guardian. This can only be performed by an"
              + " logged in guardian.")
  public ScheduleResponseDTO createSchedule(ScheduleRequestDTO scheduleRequestDTO);

  @Operation(
      summary = "List all active appointments",
      description =
          "List all active appointments. This can only be performed by a logged in ADMIN user.")
