...
public interface PetApi {
  ...
  @Operation(
      ...
      description =
          "Create a new pet. This operation can only be performed by an Logged in guardian user")
  public PetResponseDTO createPet(PetRequestDTO petRequestDTO);

  @Operation(
      summary = "List all existing pets",
      description =
          "List all existing pets. This operation can only be performed by an Logged in admin user")
  @Parameter(
      name = "name",
  ...
  public Page<PetWithGuardianResponseDTO> listPets(
      Specification<Pet> petSpec, @ParameterObject Pageable pageable);

  @Operation(
      summary = "List all pet appointments",
      description =
          "List all all pet appointments. This operation can only be performed by any Logged in"
              + " user")
  @Parameter(name = "userDetails", hidden = true)
  public Page<ScheduleResponseDTO> listPetSchedules(
      User userDetails, UUID petId, @ParameterObject Pageable pageable);
}
