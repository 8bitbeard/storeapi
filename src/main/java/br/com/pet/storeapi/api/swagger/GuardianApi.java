...
public interface GuardianApi {
  ...
  @Operation(
      ...
      description = "Create a new guardian. This action can be performed by anyone.")
  ...
  @Operation(
      ...
      description =
          "List all guardians. This action can only be performed by an logged in admin user.")
  ...
  @Parameter(
      name = "phone",
      in = ParameterIn.QUERY,
      description = "Search by pet breed",
      schema = @Schema(type = "string"),
      example = "11999999999")
  @Parameter(
      name = "document",
      in = ParameterIn.QUERY,
      description = "Search by pet specie",
      schema = @Schema(type = "string"),
      example = "02154245064")
  public Page<GuardianResponseDTO> listGuardians(
      Specification<Guardian> guardianSpec, @ParameterObject Pageable pageable);

  @Operation(
      summary = "List all pets from a guardian",
      description =
          "List all pets from a guardian. This action can only be performed by an logged in user.")
  @Parameter(name = "userDetails", hidden = true)
  @Parameter(
      name = "guardianId",
      in = ParameterIn.PATH,
      description = "Thue UUID of the guardian",
      example = "143889c3-e077-4eb2-8542-0e47aa4437f1")
  public Page<PetResponseDTO> listGuardianPets(
      User userDetails, UUID guardianId, @ParameterObject Pageable pageable);

  @Operation(
      summary = "List all appointments from a guardian",
      description =
          "List all appointments from a guardian. This action can only be performed by an logged in"
              + " user.")
  @Parameter(name = "userDetails", hidden = true)
  @Parameter(
      name = "guardianId",
