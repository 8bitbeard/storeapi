...
public interface ServiceApi {
  ...
  @Operation(summary = "Create a new service", description = "Create a new service. This operation can only be performed by an Logged in ADMIN user.")
  public ServiceResponseDTO createService(ServiceRequestDTO serviceRequestDTO);

  @Operation(summary = "List all available services", description = "List all available services. This operation can be performed by any logged in user.")
  ...
  public Page<ServiceResponseDTO> listServices(Specification<Service> serviceSpec,
